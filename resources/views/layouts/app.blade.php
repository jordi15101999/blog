...
<head>
    ...
    <script src="/js/artikel/main.js"></script>
    <title>@yield('title')</title>
    <link rel="shortcut icon" href="/img/a.png">
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="myNav">
        <a class="navbar-brand" href="/artikel"><i class="fab fa-laravel"></i> Pocong<sup>News</sup> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="/artikel/create">Create</a>
            </li>
          </ul>
        </div>
      </nav>
